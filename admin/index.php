                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="loginForm">
                                            ...
                                            <div class="alert alert-info font-weight-bold mt-2 text-center" id="wait" style="display:none;">
                                                <span class="text-white"><i class="la la-spin la-spinner"></i> Please wait...</span>
                                            </div>
                                            <div class="alert alert-danger mt-2" id="error" style="display:none;">
                                                <i class="ft-alert-triangle"></i> <span id="message"></span>
                                            </div>
                                        </form>
                                    </div>
                                </div>
